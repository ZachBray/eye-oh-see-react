...
export declare function StyledDumbView<TStyle extends IStyle, TRest>(styleObj: TStyle): (component: React.ComponentType<StylingProps<TStyle, TRest>>) => React.ComponentType<TRest>;
